...
export default function InvoicesPage() {
  ...
  const fetchInvoices = async () => {
    try {
      ...
      toast.error("Error loading invoices data");
    } finally {
      setIsLoading(false);
    }
  };
    ...
    const printContent = `
      <html>
        <head>
          ...
          <style>body { font-family: Arial; margin: 20px; } .header { text-align: center; margin-bottom: 30px; } .info { margin-bottom: 20px; } .amount { font-size: 24px; font-weight: bold; color: blue; }</style>
        </head>
        <body>
          ...
          <div class="info">
            ...
            <p><b>Total Amount:</b> ₪${invoice.total_amount.toLocaleString()}</p>
            <p><b>Paid Amount:</b> ₪${invoice.paid_amount.toLocaleString()}</p>
      ...
      <div className="space-y-8">
        <div className="flex justify-between items-center">
          ...
          <Link href="/dashboard/invoices/new">
            <Button className="bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white shadow-xl hover:shadow-2xl transition-all duration-300">
          ...
          <CardHeader className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950 dark:to-pink-950">
            ...
            <div className="flex items-center space-x-2">
              <div className="relative flex-1 max-w-sm">
                ...
                <Input
                  ...
                  className="pl-10 h-12 bg-white border-0 focus:ring-2 focus:ring-purple-500/20"
                />
              </div>
            </div>
            <div className="flex items-center space-x-2 mt-4">
              ...
              <Input
                ...
                className="h-10 bg-white border-0 focus:ring-2 focus:ring-purple-500/20"
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                    {filteredInvoices.map((invoice, index) => (
                      <tr
                        key={invoice.id}
                        className={`hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 dark:hover:from-purple-950 dark:hover:to-pink-950 transition-all duration-200 ${
                          index % 2 === 0
